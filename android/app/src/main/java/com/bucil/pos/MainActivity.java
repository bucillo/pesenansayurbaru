    ...
    private boolean openBluetoothPrinter() {
        ...
        countDownTimer = new CountDownTimer(3000, 1000) {
            public void onTick(long millisUntilFinished) {
                Log.d("Java", "seconds remaining: " + millisUntilFinished / 1000);
            }

            public void onFinish() {
                Log.d("Java", "countdown finish");
        ...
        try
        {
            ...
            uuidString = UUID.fromString("00001101-0000-1000-8000-00805f9b34fb"); //Standard SerialPortService ID
...
//            connectingThread = new ConnectingThread(bluetoothSocket, currentDevice, uuidString);
            countDownTimer.start();
            connectingThread = new ConnectingThread();
            connectingThread.start();
            connectingThread.join();
//            if(!success){
//                Log.d("Java", "print not success");
//                return false;
//            }
...
//            beginListenData();
//            success = true;
            Log.d("Java", "returning success value...");
            return success;
        }
        catch (Exception ex) {
            ex.printStackTrace();
...
//                return success;
            ...
            try{
                if(!success){
                    ...
                    inputStream = bluetoothSocket.getInputStream();
                    Log.d("Kotlin", "inputstream is assigned");
                    runOnUiThread(MainActivity.this::beginListenData);
